...
const TString inputdir  = "/afs/cern.ch/user/j/jgarciaf/www/txt-files/datacards/171004_unblinded/";
const TString outputdir = "/afs/cern.ch/user/j/jgarciaf/www/figures/Analysis_171004_unblinded/input/";
...
void Plotter(TString option = "hist", TString signal = "ttDM0001scalar00100" ){
  ...
  //plotter.AddProcess("04_TTTo2L2Nu",      "tt",         kBlue, roc_background, 1.0/35.9 );
  plotter.AddProcess("06_WW",             "WW",         color_WW,        roc_background, 1.0/35.9 );
  plotter.AddProcess("02_WZTo3LNu",       "WZ",         color_WZTo3LNu,  roc_background, 1.0/35.9 );
  plotter.AddProcess("03_VZ",             "VZ",         color_VZ,        roc_background, 1.0/35.9 );
  plotter.AddProcess("13_VVV",            "VVV",        color_VVV,       roc_background, 1.0/35.9 );
  plotter.AddProcess("07_ZJets",          "DY",         color_ZJets,     roc_background, 1.0/35.9 );
  plotter.AddProcess("09_TTV",            "ttV",        color_TTV,       roc_background, 1.0/35.9 );
  plotter.AddProcess("05_ST",             "tW",         color_ST,        roc_background, 1.0/35.9 );
  plotter.AddProcess("00_Fakes_Full2016", "non-prompt", color_Fakes,     roc_background, 1.0/35.9 ); // 1.0 is needed to not scale by luminosity
  plotter.AddProcess("04_TTTo2L2Nu",      "tt",         color_TTTo2L2Nu, roc_background, 1.0/35.9 );
  //plotter.AddProcess("04_TTTo2L2Nu_1",    "tt 1st",     color_TTTo2L2Nu, roc_background, 1.0 );
  //plotter.AddProcess("04_TTTo2L2Nu_2",    "tt 2nd",     color_TTTo2L2Nu, roc_background, 1.0 );
...
//tter.AddSignal("ttDM0001scalar00500", "m_{#chi}1 m_{S}500",    kRed, roc_signal);
//plotter.AddSignal("ttDM0001pseudo00500", "m_{#chi}1 m_{P}500",    kRed+2, roc_signal);
//plotter.AddSignal("ttDM0001pseudo00020", "m_{#chi}1 m_{S}20",    kRed+3, roc_signal);
/*plotter.AddSignal("ttDM0001pseudo00050", "m_{#chi}1 m_{P}50",    kRed+2, roc_signal);
//plotter.AddSignal("ttDM0001pseudo00100", "m_{#chi}1 m_{S}100",   kRed+7, roc_signal);
plotter.AddSignal("ttDM0001pseudo00200", "m_{#chi}1 m_{P}200",   kGreen+2, roc_signal);
//plotter.AddSignal("ttDM0001pseudo00300", "m_{#chi}1 m_{S}300",   kRed-5, roc_signal);
plotter.AddSignal("ttDM0001pseudo00500", "m_{#chi}1 m_{P}500",   kGreen+4, roc_signal);*/


if( signal.Contains("ttDM0001scalar00010") )   plotter.AddSignal("ttDM0001scalar00010", "m_{#chi}1 m_{S}10 x20",    color_Signal, roc_signal, 20./35.9   );
if( signal.Contains("ttDM0001scalar00020") )   plotter.AddSignal("ttDM0001scalar00020", "m_{#chi}1 m_{S}20 x50",    color_Signal, roc_signal, 50./35.9   );
if( signal.Contains("ttDM0001scalar00050") )   plotter.AddSignal("ttDM0001scalar00050", "m_{#chi}1 m_{S}50 x100",   color_Signal, roc_signal, 100./35.9  );
if( signal.Contains("ttDM0001scalar00100") )   plotter.AddSignal("ttDM0001scalar00100", "m_{#chi}1 m_{S}100 x200",  color_Signal, roc_signal, 200./35.9  );
if( signal.Contains("ttDM0001scalar00200") )   plotter.AddSignal("ttDM0001scalar00200", "m_{#chi}1 m_{S}200 x400",  color_Signal, roc_signal, 400./35.9  );
if( signal.Contains("ttDM0001scalar00300") )   plotter.AddSignal("ttDM0001scalar00300", "m_{#chi}1 m_{S}300 x1000", color_Signal, roc_signal, 1000./35.9 );
if( signal.Contains("ttDM0001scalar00500") )   plotter.AddSignal("ttDM0001scalar00500", "m_{#chi}1 m_{S}500 x1e4",  color_Signal, roc_signal,10000./35.9 );
if( signal.Contains("ttDM0001pseudo00010") )   plotter.AddSignal("ttDM0001pseudo00010", "m_{#chi}1 m_{P}10 x100",   color_Signal, roc_signal, 100./35.9  );
if( signal.Contains("ttDM0001pseudo00020") )   plotter.AddSignal("ttDM0001pseudo00020", "m_{#chi}1 m_{P}20 x150",   color_Signal, roc_signal, 150./35.9  );
if( signal.Contains("ttDM0001pseudo00050") )   plotter.AddSignal("ttDM0001pseudo00050", "m_{#chi}1 m_{P}50 x200",   color_Signal, roc_signal, 200./35.9  );
if( signal.Contains("ttDM0001pseudo00100") )   plotter.AddSignal("ttDM0001pseudo00100", "m_{#chi}1 m_{P}100 x300",  color_Signal, roc_signal, 300./35.9  );
if( signal.Contains("ttDM0001pseudo00200") )   plotter.AddSignal("ttDM0001pseudo00200", "m_{#chi}1 m_{P}200 x400",  color_Signal, roc_signal, 400./35.9  );
if( signal.Contains("ttDM0001pseudo00300") )   plotter.AddSignal("ttDM0001pseudo00300", "m_{#chi}1 m_{P}300 x1000", color_Signal, roc_signal, 1000./35.9 );
if( signal.Contains("ttDM0001pseudo00500") )   plotter.AddSignal("ttDM0001pseudo00500", "m_{#chi}1 m_{P}500 x1e4",  color_Signal, roc_signal,10000./35.9 );
...
cout<<"\t hey"<<endl;
  ...
  // -------------------------------------------------------------------------------------------------------------------------
//plotter.Draw( "darkpt"         , "(reconstructed) mediator p_{T}",      20, 0, "GeV",  scale, false, -4000, 2000, ymin, 1e8);
...
//plotter.Draw( "dphillmet"      , "#Delta#phi(" +sll + "," + sm + ")",  5, 2, "rad",  scale, true, 0, 3.2, ymin, 1e8);
...
//plotter.Draw( "lep1pt"         , "leading lepton p_{T}",               5, 0, "GeV",  scale, true, 0,  150, ymin, 1e8);
  //plotter.Draw( "lep2eta"        , "trailing lepton #eta",              -1, 1, "NULL", scale);
  //plotter.Draw( "lep2phi"        , "trailing lepton #phi",               5, 2, "rad",  scale);
//plotter.Draw( "lep2pt"         , "trailing lepton p_{T}",              5, 0, "GeV",  scale, true, 0,  150, ymin, 1e8);
  //plotter.Draw( "nlepton"        , "number of leptons",                 -1, 0, "NULL", scale, true, 0,  10, ymin);
//plotter.Draw( "m2l"            , "m_{" + sll + "}",                   10, 0, "GeV",  scale, true, 0,  300, ymin, 1e8);
//plotter.Draw( "metPfType1"     , sm,                                  20, 0, "GeV",  scale, true, 0,  700, ymin, 1e8);
  //plotter.Draw( "mt2lblb"        , "M_{T2}(" + sl + "b" + sl + "b)",    10, 0, "GeV",  scale, false, 0, 600);
//plotter.Draw( "mt2ll"          , "M_{T2}(" + sll + ")",               10, 0, "GeV",  scale, true, 0, 200, ymin, 1e8); 
...
plotter.Draw( "ANN_8080_julia_" + signal, "ANN output", 4, 2, "NULL", scale, true, 0, 1.0, ymin, 1e8);
